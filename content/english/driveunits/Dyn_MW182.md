...
| Lnom                  | 86.10   | dB   | nominal sensitivity (SPL at 1m for 1W @ Zn)                                    |
|                       |         |      |                                                                                |
...
| Qts (X=0, Tv)         | 0.49    | 0.44    | 0.61    |      | total Q-factor considering Re (Tv) and Rms only                                                              |
...
<img align="left" src="/images/Reviews/Drivers/Dyn_Audio/MW182/Dyn Audio MW182_harmonicDistortion_linear.png" alt="THD" width="110%" style="vertical-align:middle;margin:20px 0px"/>

<br clear="all" />

<img align="left" src="/images/Reviews/Drivers/Dyn_Audio/MW182/Dyn Audio MW182_harmonicDistortion_linear_zoom.png" alt="THDzoom" width="110%" style="vertical-align:middle;margin:20px 0px"/>

<br clear="all" />

<img align="left" src="/images/Reviews/Drivers/Dyn_Audio/MW182/Dyn Audio MW182_distortionComponents_zoom.png" alt="distortioncomponents" width="110%" style="vertical-align:middle;margin:20px 0px"/>

<br clear="all" />


<img align="left" src="/images/Reviews/Drivers/Dyn_Audio/MW182/Dyn Audio MW182_Compression_Normalized.png" alt="compression" width="110%" style="vertical-align:middle;margin:20px 0px"/>
...
<img align="left" src="/images/Reviews/Drivers/Dyn_Audio/MW182/Dyn Audio MW182_MTON_Compression 20.png" alt="MTON_Compression_20" width="100%" style="vertical-align:middle;margin:20px 0px"/>
...
<img align="left" src="/images/Reviews/Drivers/Dyn_Audio/MW182/Dyn Audio MW182_MTON_Distortion 20.png" alt="MTON_DISTORTION_20" width="100%" style="vertical-align:middle;margin:20px 0px"/>
...
<img align="left" src="/images/Reviews/Drivers/Dyn_Audio/MW182/Dyn Audio MW182_MTON_Compression 80.png" alt="MTON_Compression_80" width="100%" style="vertical-align:middle;margin:20px 0px"/>
...
<img align="left" src="/images/Reviews/Drivers/Dyn_Audio/MW182/Dyn Audio MW182_MTON_Distortion 80.png" alt="MTON_DISTORTION_80" width="100%" style="vertical-align:middle;margin:20px 0px"/>
...
* Max SPL for 80Hz to 5kHz is approximately 99dB @ 1 meter.  The compression threshold was exceeded above this SPL.
...
**Frequency Response:**
* The average sensitivity is measured at about 86.7dB from 300Hz to 1000Hz.  However, there is a +2dB "tilt" to the response below 300Hz that provides more sensitivity in the 100-200Hz region.
* On-axis response linearity is ±1.5dB within 35-1.5kHz (excluding the above-mentioned ~2dB bump)  Accounting for the bump (and thus, moving the sensitivity down) the ±1.5dB window would be approximately 40Hz-2kHz.
* On-axis response linearity is ±3.0dB within 29-1.7kHz.
...
* People will use these with different HPF frequencies and slopes so I am choosing my points for evaluation loosely: THD is below 3% above 80Hz.  2% THD at about 100dB output through the midrange with as much as 5% THD at 800Hz.  At 60Hz distortion is about 5% THD at 101dB.
* Compression reaches ~0.60dB at 50Hz at 12vRMS input.  Above 500Hz the compression increases.
* Full bandwidth (20Hz - 20kHz) multitone distortion gets above about 1% distortion thresholds below 2kHz at 99dB @ 1 meter equivalent.
* When supplied an 80Hz to 5kHz signal the multitone distortion is well below 1% THD with a max SPL of 99dB.
