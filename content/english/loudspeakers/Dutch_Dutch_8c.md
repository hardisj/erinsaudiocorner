...
The reference plane in this test is halfway between the tweeter and the midrange, as shown in the image below:
...
* You can see there is a mismatch in directivity in the crossover region (as illustrated by the balloon shape not being quite spherical at 2000Hz).  This is also seen
