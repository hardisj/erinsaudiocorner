...
reproduce the mid frequencies (see below) (fig. E). Consequently it will always be possible, as desirable, to configure the
...
### Tone Controls (High Frequency and Low Frequency)
<br>
